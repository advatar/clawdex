...
- [ ] Keep submodule bump commits isolated (one `chore(submodules)` commit), and land parity/feature ports as separate commits with tests.
  - Latest bump: 2026-02-12 (codex `befe4fbb0`, openclaw `6a12d8345`)
  ...
  - [x] Mitigate bundled OpenClaw extension supply risk: skip and auto-remove preinstalled `matrix` plugin while upstream still carries `request` GHSA-p8p7-x288-28g6 (moderate SSRF) transitively.
